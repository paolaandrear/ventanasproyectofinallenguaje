...
public class DialogoVerEstudiante extends javax.swing.JDialog {
     ...
     * @param cedula
     */
    public DialogoVerEstudiante(Curso curso, String cedula) {
        super();
        initComponents();
        ...
        this.curso = curso;
        this.cedula = cedula;
        llenarDatos(curso, cedula);
        setVisible(true);
    }

    private void llenarDatos(Curso curso, String cedula) {
        DefaultTableModel model = (DefaultTableModel) tablaNotas.getModel();
        model.setRowCount(0);
        Registro reg = curso.buscarRegistro(cedula);
        tfcedulaestudiante.setText(reg.getEstudiante().getDocumento());
        tfnombreestudiante.setText(reg.getEstudiante().getNombre());
        tfcreditosregistradosestudiante.setText(String.valueOf(reg.getEstudiante().calcularCreditos()));
        for (Evaluacion eval : curso.getEvaluaciones()) {
            ArrayList<String> datos = new ArrayList<>();
            datos.add(eval.getNombre());
            ...
            datos.add(String.valueOf(eval.getPorcentaje()));
            model.addRow(datos.toArray());
        }
        lblDefinitiva.setText(String.valueOf(reg.calcularNotaFinal()));
    }
